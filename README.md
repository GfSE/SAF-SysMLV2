# SAF-SysMLV2
Experimental Specification of SAF in SysML v2 



# alternative proposal for folder structure
...
``` everything here is for users wanting to model in sysml2 according to the SAF SysML2 specification ```

## Specification Folder "specification"
``` a representation of the SAF specification in SysML2 format```
